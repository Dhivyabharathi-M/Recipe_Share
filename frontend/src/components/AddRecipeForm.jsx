...
export default function AddRecipeForm({ onCreated }) {
  const [form, setForm]         = useState({ title: "", steps: "", image_url: "", meal_type: "", dietary_focus: "" });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setForm({ title: "", steps: "", image_url: "", meal_type: "", dietary_focus: "" });
      setTags([]);
      onCreated?.();
    } catch (err) {
      const msg = err.response?.data?.detail || "Failed to add recipe";
